...
#   GPU=3 STUDENT_TEMP=1.0 EXPERT_TEMP=1.0 bash trainer_real/run_simple_opd_lora.sh
...
RUN_NAME=${RUN_NAME:-sopd_lora_r${LORA_RANK}_${STUDENT_SHORT}_${EXPERT_SHORT}_${S_MODE}_${E_MODE}_seed${SEED}}
...
PYTHONUNBUFFERED=1 CUDA_VISIBLE_DEVICES=$GPU nohup python "$SCRIPT_DIR/simple_opd_lora.py" \
